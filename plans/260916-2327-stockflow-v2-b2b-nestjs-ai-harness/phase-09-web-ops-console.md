...
> Reservations, Copilot, audit timeline, e2e làm khi 05/08 xong. **Copilot hoàn tất 2026-09-21** (Phase 08 xong): `lib/sse.ts`, `features/copilot/{copilot-api,use-chat-stream,tool-call-badge,proposal-card,copilot-page}`, route `/copilot` ops-only, nav item.
